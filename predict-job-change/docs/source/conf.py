...
# predict_job_change documentation build
...
from predict_job_change import __version__ as release

# -- Project information -----------------------------------------------------

project = "predict_job_change"
author = "Kedro"
...
htmlhelp_basename = "predict_job_changedoc"
...
latex_documents = [
    (
        master_doc,
        "predict_job_change.tex",
        "predict_job_change Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "predict_job_change",
        "Project predict_job_change codebase.",
        "Data-Science",
    )
]
